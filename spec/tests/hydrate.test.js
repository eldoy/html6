...
test('single mask - lit', async function ({ t }) {
  var store = new Map()
  store.set('__::MASK_lit_0_::__', '42')
  var result = hydrate('value: __::MASK_lit_0_::__', store, (val, type) => val)
...
test('multiple masks - mixed types', async function ({ t }) {
  ...
  store.set('__::MASK_comp_3_::__', '<Component/>')
  store.set('__::MASK_lit_4_::__', '"text"')

  var input =
    '__::MASK_if_0_::__; __::MASK_slot_1_::__; __::MASK_map_2_::__; __::MASK_comp_3_::__; __::MASK_lit_4_::__'
  var result = hydrate(input, store, (val, type) => `[${type}:${val}]`)

  var expected =
    '[if:if(x)]; [slot:<slot>]; [map:[1,2,3].map(f)]; [comp:<Component/>]; [lit:"text"]'
  t.equal(result, expected)
})

test('repeated masks', async function ({ t }) {
  var store = new Map()
  store.set('__::MASK_lit_0_::__', 'X')
  var input = '__::MASK_lit_0_::__ __::MASK_lit_0_::__ __::MASK_lit_0_::__'
...
test('missing mask in store', async function ({ t }) {
  var store = new Map()
  var input = 'before __::MASK_lit_0_::__ after'
